...
namespace hololabCamera
{
    public class UDPSocket
    {
        ...
        /// </summary>
        public event EventHandler<hololabCamera.RtspChunkEventArgs> DataReceived;
        ...
        protected void OnDataReceived(hololabCamera.RtspChunkEventArgs rtspChunkEventArgs)
        {
            EventHandler<hololabCamera.RtspChunkEventArgs> handler = DataReceived;
        ...
        private void DoWorkerJob(System.Net.Sockets.UdpClient socket, int data_port)
        {
            ...
            try
            {
                ...
                while (true)
                {
                    ...
                    hololabCamera.Messages.RtspChunk currentMessage = new hololabCamera.Messages.RtspData();
                    // aMessage.SourcePort = ??
                    currentMessage.Data = frame;
                    ((hololabCamera.Messages.RtspData)currentMessage).Channel = data_port;


                    OnDataReceived(new hololabCamera.RtspChunkEventArgs(currentMessage));
